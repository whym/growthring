'''This is a proof-of-concept script to show it is possible to
"concatenate" two suffix arrays that represent two concecutive regions
in a string. It assumes the regions are delimited by a special
boundary character.
...
def merge(left, right, key):
    ...
    This *has to be* linear in time, but it is not proven to be so
    (and I'm not positive to prove so) when "key" is looking at
    subsequent characters.  What is an efficient alternative?
